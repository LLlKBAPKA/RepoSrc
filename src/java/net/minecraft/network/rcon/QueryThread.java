...
public class QueryThread extends RConThread {
    ...
    private QueryThread(IServer p_i241890_1_, int p_i241890_2_) {
        ...
        if (!this.serverHostname.isEmpty() && !this.queryHostname.equals(this.serverHostname)) {
            ...
            try {
                ...
                field_232648_d_.warn("Unable to determine local host IP, please set server-ip in server.properties", unknownhostexception);
            }
        }
    ...
    public static QueryThread func_242129_a(IServer p_242129_0_) {
        ...
        if (0 < i && 65535 >= i) {
            ...
            field_232648_d_.warn("Invalid query port {} found in server.properties (queries disabled)", i);
            return null;
        }
    }
    ...
    public boolean func_241832_a() {
        if (this.running) {
            ...
            return this.initQuerySystem() && super.func_241832_a();
        }
    }
    ...
    private void stopWithException(Exception exception) {
        if (this.running) {
            field_232648_d_.warn("Unexpected exception", exception);
