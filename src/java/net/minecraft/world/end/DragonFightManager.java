...
public class DragonFightManager {
    ...
    private void generateGateway(BlockPos pos) {
        ...
        Features.END_GATEWAY_DELAYED.func_242765_a(this.world, this.world.getChunkProvider().getChunkGenerator(), new FastRandom(), pos);
    }
    ...
    private void generatePortal(boolean active) {
        ...
        endpodiumfeature.withConfiguration(IFeatureConfig.NO_FEATURE_CONFIG).func_242765_a(this.world, this.world.getChunkProvider().getChunkGenerator(), new FastRandom(), this.exitPortalLocation);
    }
