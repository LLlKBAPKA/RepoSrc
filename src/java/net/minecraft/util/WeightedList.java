...
public class WeightedList<U> {
    ...
    public static <U> Codec<WeightedList<U>> func_234002_a_(Codec<U> p_234002_0_) {
        return WeightedList.Entry.func_234008_a_(p_234002_0_).listOf().xmap(WeightedList::new, (p_234001_0_) ->
        {
    ...
    public static class Entry<T> {
        ...
        private void func_220648_a(float p_220648_1_) {
            this.field_220653_d = -Math.pow(p_220648_1_, 1.0F / (float) this.field_220652_c);
        }
