...
public class Vector3d implements IPosition {
    ...
    public static Vector3d copyCenteredHorizontally(Vector3i toCopy) {
        return new Vector3d((double) toCopy.getX() + 0.5D, toCopy.getY(), (double) toCopy.getZ() + 0.5D);
    }
    ...
    public Vector3d lerp(Vector3d vec, float factor) {
        return new Vector3d(
                Interpolator.lerp(this.getX(), vec.getX(), factor),
                Interpolator.lerp(this.getY(), vec.getY(), factor),
                Interpolator.lerp(this.getZ(), vec.getZ(), factor)
        );
    }
