...
import org.excellent.client.managers.module.impl.movement.ScreenWalk;
...
public class KeyBinding implements Comparable<KeyBinding> {
    ...
    public static void unPressAllMoveKeys() {
        for (KeyBinding keybinding : ScreenWalk.getInstance().moveKeys()) {
            keybinding.unpressKey();
        }
    }
