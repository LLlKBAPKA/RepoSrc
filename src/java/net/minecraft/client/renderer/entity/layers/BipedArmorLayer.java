        ...
        if (itemstack.getItem() instanceof ArmorItem armoritem) {
            ...
            if (armoritem.getEquipmentSlot() == p_241739_4_) {
                ...
                if (armoritem instanceof IDyeableArmorItem) {
                    ...
                    this.renderModel(p_241739_1_, p_241739_2_, p_241739_5_, flag, p_241739_6_, f, f1, f2, this.getArmorResource(p_241739_3_, itemstack, p_241739_4_, null));
                    ...
                    this.renderModel(p_241739_1_, p_241739_2_, p_241739_5_, flag, p_241739_6_, 1.0F, 1.0F, 1.0F, this.getArmorResource(p_241739_3_, itemstack, p_241739_4_, null));
                }
            }
        }
    }
