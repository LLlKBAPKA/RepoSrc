...
import org.excellent.client.managers.events.other.TotemPopEvent;
...
public class ClientPlayNetHandler implements IClientPlayNetHandler {
     ...
     */
    private final Random avRandomizer = new FastRandom();
    ...
    public void handleJoinGame(SJoinGamePacket packetIn) {
        ...
        this.world = new ClientWorld(this, clientworld$clientworldinfo, registrykey, dimensiontype, this.viewDistance, this.client.worldRenderer, flag, packetIn.getHashedSeed());
    ...
    public void handleMultiBlockChange(SMultiBlockChangePacket packetIn) {
        ...
        packetIn.func_244310_a((p_243492_2_, p_243492_3_) -> this.world.setBlockState(p_243492_2_, p_243492_3_, i));
    }
    ...
    public void onDisconnect(ITextComponent reason) {
        ...
        this.client.displayScreen(new DisconnectedScreen(Objects.requireNonNullElseGet(this.guiScreenServer, () -> new MultiplayerScreen(new MainMenu())), field_243491_b, reason));
    }
    ...
    public void handleChat(SChatPacket packetIn) {
        PacketThreadUtil.checkThreadAndEnqueue(packetIn, this, this.client);
        this.client.ingameGUI.handleChatPacket(packetIn.getType(), packetIn.getChatComponent(), packetIn.func_240810_e_());
    }
...
//            LOGGER.warn("Skipping Entity with id {}", packetIn.getEntityType());
    ...
    public void func_230488_a_(SWorldSpawnChangedPacket p_230488_1_) {
        ...
        this.client.world.setSpawn(p_230488_1_.func_240832_b_(), p_230488_1_.func_244313_c());
    }
    ...
    public void handleEntityStatus(SEntityStatusPacket packetIn) {
        ...
        if (packetIn.getOpCode() == 21) {
            ...
            if (noRender.isEnabled() && noRender.elements().getValue("Анимация тотема")) return;
    ...
    public void handleSetSlot(SSetSlotPacket packetIn) {
        ...
        if (windowId == -1) {
            ...
            } else if (windowId == playerentity.openContainer.windowId && (windowId != 0 || !flag)) {
    ...
    public void handleCustomPayload(SCustomPayloadPlayPacket packetIn) {
        ...
        try {
            ...
            } else if (resourcelocation.getPath().equals("custom_ping_packet")) { // for via
                PacketBuffer packetBuffer = (new PacketBuffer(Unpooled.buffer()));
                packetBuffer.writeInt(packetIn.getBufferData().readInt());
                this.netManager.sendPacket(new CCustomPayloadPacket(resourcelocation, packetBuffer));
            } else {
