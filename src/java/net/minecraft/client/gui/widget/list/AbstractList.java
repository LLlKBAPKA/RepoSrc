...
public abstract class AbstractList<E extends AbstractList.AbstractListEntry<E>> extends FocusableGui implements IRenderable {
    ...
    protected final E getEntryAtPosition(double p_230933_1_, double p_230933_3_) {
        ...
        return p_230933_1_ < (double) this.getScrollbarPosition() && p_230933_1_ >= (double) k && p_230933_1_ <= (double) l && j1 >= 0 && i1 >= 0 && j1 < this.getItemCount() ? this.getEventListeners().get(j1) : null;
    }
    ...
    protected void renderList(MatrixStack p_238478_1_, int p_238478_2_, int p_238478_3_, int p_238478_4_, int p_238478_5_, float p_238478_6_) {
        ...
        for (int j = 0; j < i; ++j) {
            ...
            if (l >= this.y0 && k <= this.y1) {
                ...
                e.render(p_238478_1_, j, k, j2, k1, j1, p_238478_4_, p_238478_5_, this.isMouseOver(p_238478_4_, p_238478_5_) && Objects.equals(this.getEntryAtPosition(p_238478_4_, p_238478_5_), e), p_238478_6_);
            }
        }
    }
    ...
    protected E remove(int p_230964_1_) {
        ...
        return this.removeEntry(this.children.get(p_230964_1_)) ? e : null;
    }
