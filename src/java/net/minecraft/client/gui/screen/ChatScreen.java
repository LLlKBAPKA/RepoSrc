...
public class ChatScreen extends Screen {
    ...
    public void render(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks) {
        ...
        final BetterMinecraft betterMinecraft = BetterMinecraft.getInstance();
        if (betterMinecraft.isEnabled() && betterMinecraft.simpleChat().getValue()) {
            fill(matrixStack, 2, this.height - 14, 2 + font.getStringWidth(inputField.getText().isEmpty() ? "_" : inputField.getText()) + 4, this.height - 2, this.minecraft.gameSettings.getChatBackgroundColor(Integer.MIN_VALUE));
        } else {
