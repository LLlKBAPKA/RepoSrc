...
import org.excellent.client.managers.events.other.ScreenOpenEvent;
...
public abstract class Screen extends FocusableGui implements IScreen, IRenderable {
    ...
    public void renderTooltip(MatrixStack matrixStack, ITextComponent text, int mouseX, int mouseY) {
        this.renderTooltip(matrixStack, List.of(text.func_241878_f()), mouseX, mouseY);
    }
                ...
                if (clickevent.getAction() == ClickEvent.Action.OPEN_URL) {
                    ...
                    try {
                        ...
                        if (this.minecraft.gameSettings.chatLinksPrompt) {
                            ...
                            this.minecraft.displayScreen(new ConfirmOpenLinkScreen(this::confirmLink, clickevent.getValue(), false));
                        } else {
                            this.openLink(uri);
                        }
                    ...
                    LOGGER.error("Don't know how to post {}", clickevent);
                }
    ...
    public void init(Minecraft minecraft, int width, int height) {
        ...
        ScreenOpenEvent event = new ScreenOpenEvent(this);
        event.hook();
