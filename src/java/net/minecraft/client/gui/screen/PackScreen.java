...
public class PackScreen extends Screen {
    ...
    public void closeScreen() {
        ...
        this.minecraft.displayScreen(this.field_238888_r_);
        this.func_243399_k();
    }
    ...
    public void tick() {
        if (this.field_243392_s != null) {
            try {
                ...
                field_238883_a_.warn("Failed to poll for directory {} changes, stopping", this.field_241817_w_);
                this.func_243399_k();
            }
        }
    ...
    public void render(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks) {
        ...
        drawCenteredStringWithShadow(matrixStack, this.font, this.title, this.width / 2, 8, 16777215);
        drawCenteredStringWithShadow(matrixStack, this.font, field_238884_b_, this.width / 2, 20, 16777215);
    ...
    public void addPacks(List<Path> packs) {
        ...
        this.minecraft.displayScreen(new ConfirmScreen((p_238902_2_) ->
        {
            if (p_238902_2_) {
