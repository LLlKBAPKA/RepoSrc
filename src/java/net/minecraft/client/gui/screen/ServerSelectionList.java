...
public class ServerSelectionList extends ExtendedList<ServerSelectionList.Entry> {
    ...
    public static class LanDetectedEntry extends ServerSelectionList.Entry {
        ...
        public void render(MatrixStack p_230432_1_, int p_230432_2_, int p_230432_3_, int p_230432_4_, int p_230432_5_, int p_230432_6_, int p_230432_7_, int p_230432_8_, boolean p_230432_9_, float p_230432_10_) {
            this.mc.fontRenderer.drawString(p_230432_1_, field_243386_c, (float) (p_230432_4_ + 32 + 3), (float) (p_230432_3_ + 1), 16777215);
            ...
            if (this.mc.gameSettings.hideServerAddress) {
                this.mc.fontRenderer.drawString(p_230432_1_, field_243387_d, (float) (p_230432_4_ + 32 + 3), (float) (p_230432_3_ + 12 + 11), 3158064);
            } else {
    ...
    public static class LanScanEntry extends ServerSelectionList.Entry {
        ...
        public void render(MatrixStack p_230432_1_, int p_230432_2_, int p_230432_3_, int p_230432_4_, int p_230432_5_, int p_230432_6_, int p_230432_7_, int p_230432_8_, boolean p_230432_9_, float p_230432_10_) {
            ...
            this.mc.fontRenderer.drawString(p_230432_1_, ServerSelectionList.field_243365_r, (float) (this.mc.currentScreen.width / 2 - this.mc.fontRenderer.getStringPropertyWidth(ServerSelectionList.field_243365_r) / 2), (float) i, 16777215);
            String s;
    ...
    public class NormalEntry extends ServerSelectionList.Entry {
        ...
        public void render(MatrixStack p_230432_1_, int p_230432_2_, int p_230432_3_, int p_230432_4_, int p_230432_5_, int p_230432_6_, int p_230432_7_, int p_230432_8_, boolean p_230432_9_, float p_230432_10_) {
            ...
            if (server.isAutodob()) {
                int customColor = ColorUtil.getColor(255, 127, 102);
                RenderUtil.Shadow.drawShadow(p_230432_1_, p_230432_4_, p_230432_3_, 300, 32, 10, customColor);
                RenderUtil.Rounded.smooth(p_230432_1_, p_230432_4_, p_230432_3_, 300, 32, ColorUtil.multDark(customColor, 0.25F), Round.of(0));
            }
            ...
            for (int i = 0; i < Math.min(list.size(), 2); ++i) {
                this.mc.fontRenderer.drawString(p_230432_1_, list.get(i), (float) (p_230432_4_ + 32 + 3), (float) (p_230432_3_ + 12 + 9 * i), 8421504);
            }

            ITextComponent itextcomponent1 = flag ? this.server.gameVersion.deepCopy().mergeStyle(TextFormatting.RED) : this.server.populationInfo;
            int j = this.mc.fontRenderer.getStringPropertyWidth(itextcomponent1);
            this.mc.fontRenderer.drawString(p_230432_1_, itextcomponent1, (float) (p_230432_4_ + p_230432_5_ - j - 15 - 2), (float) (p_230432_3_ + 1), 8421504);
            int k = 0;
            int l;
            ...
            if (flag) {
                ...
                k = 1;
                l = (int) (Util.milliTime() / 100L + (p_230432_2_ * 2L) & 7L);
        ...
        private void func_228196_a_(int p_228196_1_, int p_228196_2_) {
            Entry entry1 = this.owner.serverListSelector.getEventListeners().get(p_228196_1_);
            Entry entry2 = this.owner.serverListSelector.getEventListeners().get(p_228196_2_);

            if (entry1 != null && entry2 != null) {
                if (entry1 instanceof NormalEntry normalEntry1 && entry2 instanceof NormalEntry normalEntry2) {
                    if (normalEntry1.server.isAutodob() || normalEntry2.server.isAutodob()) {
                        return;
                    }
                }
            }
