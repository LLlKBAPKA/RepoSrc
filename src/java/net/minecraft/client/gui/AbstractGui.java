...
public abstract class AbstractGui {
    ...
    public static void drawCenteredStringWithShadow(MatrixStack matrixStack, FontRenderer fontRenderer, String font, int text, int x, int y) {
        fontRenderer.drawStringWithShadow(matrixStack, font, (float) (text - fontRenderer.getStringWidth(font) / 2), (float) x, y);
    }

    public static void drawCenteredStringWithShadow(MatrixStack matrixStack, FontRenderer fontRenderer, ITextComponent font, int text, int x, int y) {
        IReorderingProcessor ireorderingprocessor = font.func_241878_f();
        fontRenderer.drawStringWithShadow(matrixStack, ireorderingprocessor, (float) (text - fontRenderer.func_243245_a(ireorderingprocessor) / 2), (float) x, y);
    }

    public static void drawStringWithShadow(MatrixStack matrixStack, FontRenderer fontRenderer, String font, int text, int x, int y) {
        fontRenderer.drawStringWithShadow(matrixStack, font, (float) text, (float) x, y);
    }

    public static void drawStringWithShadow(MatrixStack matrixStack, FontRenderer fontRenderer, ITextComponent font, int text, int x, int y) {
        fontRenderer.drawStringWithShadow(matrixStack, font, (float) text, (float) x, y);
    }
