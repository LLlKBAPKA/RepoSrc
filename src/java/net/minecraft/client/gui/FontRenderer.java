...
public class FontRenderer {
    ...
    private final IGlyph glyphAdvanceSpace = new GlyphAdvanceFixed(4.0F);
    ...
    public FontRenderer(Function<ResourceLocation, Font> p_i232249_1_) {
        ...
        this.field_238402_e_ = new CharacterManager((p_lambda$new$0_1_, p_lambda$new$0_2_) ->
                this.getFont(p_lambda$new$0_2_.getFontId()).func_238557_a_(p_lambda$new$0_1_).getAdvance(p_lambda$new$0_2_.getBold()));
    }
    ...
    public int drawStringWithShadow(MatrixStack p_238406_1_, String p_238406_2_, float p_238406_3_, float p_238406_4_, int p_238406_5_, boolean p_238406_6_) {
    ...
    public int drawStringWithShadow(MatrixStack p_238407_1_, IReorderingProcessor p_238407_2_, float p_238407_3_, float p_238407_4_, int p_238407_5_) {
        RenderSystem.enableAlphaTest();
        return this.func_238415_a_(p_238407_2_, p_238407_3_, p_238407_4_, p_238407_5_, p_238407_1_.getLast().getMatrix(), true);
    }

    public int drawStringWithShadow(MatrixStack p_243246_1_, ITextComponent p_243246_2_, float p_243246_3_, float p_243246_4_, int p_243246_5_) {
        RenderSystem.enableAlphaTest();
    ...
    public int drawString(MatrixStack matrixStack, IReorderingProcessor properties, float x, float y, int color) {
        RenderSystem.enableAlphaTest();
        return this.func_238415_a_(properties, x, y, color, matrixStack.getLast().getMatrix(), false);
    }

    public int drawString(MatrixStack p_243248_1_, ITextComponent p_243248_2_, float p_243248_3_, float p_243248_4_, int p_243248_5_) {
        RenderSystem.enableAlphaTest();
    ...
    class CharacterRenderer implements ICharacterConsumer {
        ...
        private final float field_238439_m_;
        @Nullable
