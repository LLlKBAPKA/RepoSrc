...
public class ClientChunkProvider extends AbstractChunkProvider {
        ...
        if (!this.array.inView(chunkX, chunkZ)) {
            ...
            if (!p_228313_7_ && isValid(chunk, chunkX, chunkZ)) {
                ...
                if (chunk instanceof ChunkOF chunkof) {
                    ...
                    if (object instanceof ChunkDataOF chunkdataof) {
    ...
    final class ChunkArray {
        ...
        private void replace(int chunkIndex, @Nullable Chunk chunkIn) {
        ...
        private Chunk unload(int chunkIndex, Chunk chunkIn, @Nullable Chunk replaceWith) {
        ...
        @Nullable
        private Chunk get(int chunkIndex) {
