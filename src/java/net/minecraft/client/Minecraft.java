...
import org.excellent.client.managers.events.other.ScreenResizeEvent;
import org.excellent.client.managers.events.other.TickEvent;
...
import org.excellent.client.managers.module.impl.misc.EnderChestPlus;
import org.excellent.client.managers.module.impl.player.FreeCam;
import org.excellent.client.screen.mainmenu.MainMenu;
import org.excellent.common.impl.viaversion.fixes.AttackOrder;
...
public class Minecraft extends RecursiveEventLoop<Runnable> implements IWindowEventListener {
    ...
    public void displayScreen(@Nullable Screen guiScreenIn) {
        ...
        if (guiScreenIn instanceof MainMenuScreen || guiScreenIn instanceof MultiplayerScreen) {
            ...
            if (!(Excellent.initialized() && BetterMinecraft.getInstance().isEnabled() && BetterMinecraft.getInstance().chatHistory().getValue()))
