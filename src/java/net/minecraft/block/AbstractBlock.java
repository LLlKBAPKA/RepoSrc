...
public abstract class AbstractBlock {
    ...
    public boolean allowsMovement(BlockState state, IBlockReader worldIn, BlockPos pos, PathType type) {
        return switch (type) {
            case LAND, AIR -> !state.hasOpaqueCollisionShape(worldIn, pos);
            case WATER -> worldIn.getFluidState(pos).isTagged(FluidTags.WATER);
        };
    }
     ...
     * call via  whenever possible. Implementing/overriding is fine.
     */
    ...
    /**
     * call via  whenever possible. Implementing/overriding
     * is fine.
     */
     ...
     * blockstate.
     * call via  whenever possible. Implementing/overriding is
     * fine.
     */
    ...
    public abstract static class AbstractBlockState extends StateHolder<Block, BlockState> {
        ...
        static final class Cache {
            ...
            final boolean opaqueCollisionShape;
