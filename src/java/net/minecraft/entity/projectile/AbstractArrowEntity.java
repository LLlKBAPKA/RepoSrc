    ...
    protected void onEntityHit(EntityRayTraceResult p_213868_1_) {
        ...
        if (entity.attackEntityFrom(damagesource, (float) i)) {
            ...
            if (entity instanceof LivingEntity livingentity) {
                ...
                if (!this.world.isRemote && entity1 instanceof ServerPlayerEntity serverplayerentity) {
                    ...
                    if (this.hitEntities != null && this.getShotFromCrossbow()) {
                        ...
                        CriteriaTriggers.KILLED_BY_CROSSBOW.test(serverplayerentity, List.of(entity));
                    }
                }
            }
