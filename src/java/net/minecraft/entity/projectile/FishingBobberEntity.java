...
public class FishingBobberEntity extends ProjectileEntity {
    private final Random field_234596_b_ = new FastRandom();
    ...
    private void catchingFish(BlockPos p_190621_1_) {
        ...
        if (this.ticksCatchable > 0) {
            ...
            if (this.ticksCatchableDelay > 0) {
                ...
                serverworld.spawnParticle(ParticleTypes.BUBBLE, this.getPosX(), d3, this.getPosZ(), (int) (1.0F + this.getWidth() * 20.0F), this.getWidth(), 0.0D, this.getWidth(), 0.2F);
                serverworld.spawnParticle(ParticleTypes.FISHING, this.getPosX(), d3, this.getPosZ(), (int) (1.0F + this.getWidth() * 20.0F), this.getWidth(), 0.0D, this.getWidth(), 0.2F);
            ...
            if (this.rand.nextFloat() < f5) {
                ...
                if (blockstate1.isIn(Blocks.WATER)) {
                    serverworld.spawnParticle(ParticleTypes.SPLASH, d4, d5, d6, 2 + this.rand.nextInt(2), 0.1F, 0.0D, 0.1F, 0.0D);
                }
            }
