...
public class GuiScreenCapeOF extends GuiScreenOF {
    ...
    public void render(MatrixStack matrixStackIn, int mouseX, int mouseY, float partialTicks) {
        ...
        drawCenteredStringWithShadow(matrixStackIn, this.fontRenderer, this.title, this.width / 2, 20, 16777215);

        if (this.message != null) {
            drawCenteredStringWithShadow(matrixStackIn, this.fontRenderer, this.message, this.width / 2, this.height / 6 + 60, 16777215);
