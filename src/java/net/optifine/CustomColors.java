...
public class CustomColors {
    ...
    public static Random random = new FastRandom();
    private static final CustomColors.IColorizer COLORIZER_GRASS = new CustomColors.IColorizer() {
        public int getColor(BlockState blockState, IBlockDisplayReader blockAccess, BlockPos blockPos) {
            ...
            return CustomColors.swampGrassColors != null && biome == BiomeUtils.SWAMP ? CustomColors.swampGrassColors.getColor(biome, blockPos) : biome.getGrassColor(blockPos.getX(), blockPos.getZ());
        }
    ...
    public static Vector3d getSkyColor(Vector3d skyColor3d, IBlockDisplayReader blockAccess, double x, double y, double z) {
        if (skyColors == null) {
            ...
            WorldColorEvent worldColorEvent = new WorldColorEvent(f, f1, f2);
            ...
            return skyColorFader.getColor(eventRed, eventGreen, eventBlue);
        }
    }
    ...
    private static Vector3d getFogColor(Vector3d fogColor3d, IBlockDisplayReader blockAccess, double x, double y, double z) {
        if (fogColors == null) {
            ...
            float eventGreen = worldColorEvent.getGreen();
            float eventBlue = worldColorEvent.getBlue();
            return fogColorFader.getColor(eventRed, eventGreen, eventBlue);
        }
    }
