...
public interface IVertexBuilder {
    ...
    default IVertexBuilder color(int color) {
        float[] colors = ColorUtil.getRGBAf(color);
    ...
    default IVertexBuilder pos(Matrix4f matrixIn, float x, float y) {
        float f = matrixIn.getTransformX(x, y, 0, 1.0F);
        float f1 = matrixIn.getTransformY(x, y, 0, 1.0F);
        float f2 = matrixIn.getTransformZ(x, y, 0, 1.0F);
        return this.pos(f, f1, f2);
    }
