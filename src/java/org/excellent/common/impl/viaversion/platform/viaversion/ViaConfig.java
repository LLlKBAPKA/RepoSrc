...
public class ViaConfig
    ...
    private static final List<String> UNSUPPORTED = Arrays.asList(
            ...
            "quick-move-action-fix", "nms-player-ticking", "velocity-ping-interval", "velocity-ping-save",
            "velocity-servers", "blockconnection-method", "change-1_9-hitbox", "change-1_14-hitbox",
